    ...
    def process_step(self, frame, game_state: Dict[str, Any]) -> str:
        ...
        try:
            ...
            if items:
                ...
                inventory_str = "None"
            ascii_map_lines = _format_map_info(map_info, player_data, include_npcs=True, full_state_data=game_state, use_json_map=False)
            ascii_map = "\n".join(ascii_map_lines) if ascii_map_lines else ""
